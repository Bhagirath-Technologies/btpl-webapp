        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 col-lg-3 mb-5">
              ...
              <p>
                Bhagirath Technologies Pvt Ltd Your partner for innovative IT
                solutions.
              </p>
                      ...
                      <div class="user_in">
                        <div class="img_in">
                          ...
                          <Link
                            ...
                            to="https://www.instagram.com/bhagirath_technologies/"
                            target="_blank"
                          >
                            In
                          </Link>
                        ...
                        <div class="details_in">
                          ...
                          <div class="username_in">
                            <Link
                              className="text-white"
                              to="https://www.instagram.com/bhagirath_technologies/"
                              target="_blank"
                            >
                              bhagirath_technologies
                            </Link>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="user_fb">
                        <div class="img_fb">
                          <Link
                            ...
                            to="https://www.facebook.com/bhagirathtechnologies/"
                            target="_blank"
                          >
                            Fb
                          </Link>
                      ...
                      <div class="user_ln">
                        ...
                        <div class="details_ln">
                          <div class="name_ln">
                            <Link
                              className="text-muted"
                              to="https://in.linkedin.com/company/bhagirath-technologies"
                              target="_blank"
                            >
                              BTPL
                            </Link>
                          </div>
                          <div class="username_ln">
                            <Link
                              className="text-muted"
                              to="https://in.linkedin.com/company/bhagirath-technologies"
                              target="_blank"
                    ...
                    <div class="profile_ln">
                      <div class="user_ln">
                        <div class="img_ln">
                          <Link
                            className="text-muted"
                            to="https://t.me/bhagirathtechnologies"
                            target="_blank"
                          >
                            Tg
                          </Link>
            ...
            <div class="col-md-6 col-lg-3 mb-5">
              ...
              <address class="mb-0">
                Flat No 202, Esteem Homes, Plot No 65-A, Indrapuri, Bhopal,
                Madhya Pradesh, Pincode - 462023
              </address>
              <p>
                Call:{" "}
                <Link to="tel:+918982301484" class="text-body">
                  <u> +91-8982301484</u>
                </Link>{" "}
              </p>
              {/* <!-- Address 2 --> */}
              ...
              <address class="mb-0">
                Office No.8, 1st Floor, A-43, Sector-2, Near-Sector-15 Metro
                Station, Noida, Uttar Pradesh, Pincode - 201301
              </address>
              <p>
                Call:{" "}
                <Link to="tel:+919625965251" class="text-body">
                  <u>91-9625965251</u>
                </Link>{" "}
              </p>
            </div>
            ...
            <div className="col-md-6 col-lg-3 mb-5">
              ...
              <div class="pt-2">
                <div className="d-flex">
                  ...
                  <a
                    class="text-body d-block mb-2"
                    href="mailto:info@bhagirathtechnologies.com"
                  >
          ...
          <div class="row align-items-center justify-content-md-between py-2">
            ...
            <div class="col-md-6">
              <ul class="nav justify-content-center justify-content-md-end mt-3 mt-md-0">
                <li class="nav-item">
                  <Link
                    class="nav-link text-body text-primary-hover fs-7"
                    to="/terms"
                  >
                    Terms
                  </Link>
                ...
                <li class="nav-item">
                  <Link
                    class="nav-link text-body text-primary-hover fs-7 pe-0"
                    to="/cookies"
                  >
                    Cookies
                  </Link>
