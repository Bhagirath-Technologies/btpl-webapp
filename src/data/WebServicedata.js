const webData = [
  ...
  },
  {
    ...
    image: "../assets/images/services/8.webp",
      ...
      "../assets/images/icons/Figma Design/5.svg",
      "../assets/images/icons/Figma Design/6.svg",
      "../assets/images/icons/Figma Design/7.svg",
      "../assets/images/icons/Figma Design/8.svg",
    ],
    class: "col-sm-6 col-md-4 col-lg-3 col-xxl-3",
    hashlinks: "service_detail",
    data_aos_delay: "1200",
  },
  {
    ...
    image: "../assets/images/services/9.webp",
      ...
      "../assets/images/icons/Digital Marketing/8.svg",
    ],
    class: "col-sm-6 col-md-4 col-lg-3 col-xxl-3",
    hashlinks: "service_detail",
    data_aos_delay: "300",
  ...
  },
  {
    ...
    image: "../assets/images/services/11.webp",
      ...
      "../assets/images/icons/Google Ads Campaigns/5.svg",
      "../assets/images/icons/Google Ads Campaigns/6.svg",
      "../assets/images/icons/Google Ads Campaigns/7.svg",
      "../assets/images/icons/Google Ads Campaigns/8.svg",
    ],
    class: "col-sm-6 col-md-4 col-lg-3 col-xxl-3",
    hashlinks: "service_detail",
    data_aos_delay: "900",
  ...
  },
  {
    ...
    image: "../assets/images/services/15.webp",
      ...
      "../assets/images/icons/Visual Design/7.svg",
      "../assets/images/icons/Visual Design/8.svg",
    ],
    class: "col-sm-6 col-md-4 col-lg-3 col-xxl-3",
    hashlinks: "service_detail",
    data_aos_delay: "900",
